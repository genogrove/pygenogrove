...
class TestSerialize:
    ...
    def test_roundtrip_empty_grove(self, tmp_path):
        pg = _pg()
    ...
    def test_roundtrip_preserves_external_keys(self, tmp_path):
        pg = _pg()
    ...
    def test_roundtrip_edge_chain_across_splits(self, tmp_path):
    ...
    def test_deserialize_corrupt_file_raises(self, tmp_path):
